...
==============================
Executive Discovery Reporting Module.

Synthesizes high-level discovery metrics and prioritizes candidates for 
researchers. Generates the final repository-level discovery summary report 
incorporating ML scores and multi-system analysis.
"""
...
def generate_discovery_summary():
    ...
    try:
        ...
        with open(report_path, "w") as f:
            ...
            f.write("------------------------------------------------------------\n")
            f.write("Generated by the ExoIntel Pipeline Orchestrator.\n")
            f.write("============================================================\n")
